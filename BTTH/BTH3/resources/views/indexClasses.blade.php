		...
		<div class="table-wrapper">
			...
			<table class="table table-striped table-hover">
                ...
                @foreach($classes as $classe)
                    <tr>
                        <td>
                            <span classe="custom-checkbox">
                                <input type="checkbox" id="checkbox{{ $classe->id }}" name="options[]" value="{{ $classe->id }}">
                                <label for="checkbox{{ $classe->id }}"></label>
                            </span>
                        </td>
                        <td>{{ $classe->grade_level  }}</td>
                        <td>{{ $classe->room_number }}</td>
